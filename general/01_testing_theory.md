...
- <- Monitoring and Control (each testing process step) ->
...
- Non-Functional (how well the system behaves - compatibility, portability, usability, performance,
  reliability, robustness, maintainability, security (*holy war topic))
