# Waiters, Soft Assertions, AAA, Selectors

## Explicit and Implicit waiters
- Implicit Wait - automatically waits for a set amount of time for elements to appear
  before throwing an error and applies to all elements
...
- Difference - CSS works top-down (from parent to child), XPath works top-down (from parent to child)
  and bottom-up (from child to parent)
